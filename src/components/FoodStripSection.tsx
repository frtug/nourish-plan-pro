...
const foods = [
  ...
  { emoji: "🍋", name: "Lemon", benefit: "Vitamin C" },
  { emoji: "🌿", name: "Spinach", benefit: "Iron & Magnesium" },
  { emoji: "🐟", name: "Salmon", benefit: "Omega-3s" },
  { emoji: "🌰", name: "Walnuts", benefit: "Brain Health" },
  { emoji: "🫚", name: "Olive Oil", benefit: "Anti-inflammatory" },
  ...
  { emoji: "🌾", name: "Jowar", benefit: "Gluten Free Energy" },
  { emoji: "🫘", name: "Moong Dal", benefit: "Easy Protein" },
  { emoji: "🫘", name: "Masoor Dal", benefit: "Iron & Protein" },
  { emoji: "🧆", name: "Chickpeas (Chana)", benefit: "Satiety & Protein" },
  { emoji: "🫘", name: "Rajma", benefit: "Fibre & Folate" },
  { emoji: "🫘", name: "Black Chana", benefit: "Steady Energy" },
  { emoji: "🥛", name: "Curd (Dahi)", benefit: "Gut Friendly Probiotics" },
  { emoji: "🌱", name: "Flaxseed (Alsi)", benefit: "Omega-3 & Fibre" },
  { emoji: "⚪", name: "Sesame (Til)", benefit: "Calcium & Zinc" },
  { emoji: "🥬", name: "Mustard Greens", benefit: "Vitamin K" },
  ...
  { emoji: "🥒", name: "Bottle Gourd (Lauki)", benefit: "Hydration & Lightness" },
  { emoji: "🍈", name: "Guava", benefit: "Fibre + Vitamin C" },
  { emoji: "🌾", name: "Foxtail Millet (Kangni)", benefit: "Low-GI Carbs" },
  { emoji: "🌰", name: "Lotus Seeds (Makhana)", benefit: "Light Protein Snack" },
  { emoji: "🧅", name: "Onion", benefit: "Prebiotic Support" },
  { emoji: "🟤", name: "Jaggery (Gur)", benefit: "Iron Trace Minerals" },
